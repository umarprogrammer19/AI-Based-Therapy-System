...
from . import knowledge_docs, vector_chunks, audit_logs, chat, authenticated_chat, admin, auth, user_docs
...
router.include_router(authenticated_chat.router, prefix="/chat", tags=["chat"])
